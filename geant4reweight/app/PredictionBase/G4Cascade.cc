...
int main(int argc, char * argv[]){
  ...
  int nPi0 = 0, nPiPlus = 0, nPiMinus = 0, nProton=0, nNeutron=0;
  double momentum;
...
switch( theConfig.type ){
  ...
  if( theConfig.type == 2112||theConfig.type == 2212 ){
    cuts["piprod"] = " (nPi0 + nPiPlus + nPiMinus) > 0";
    cuts["abs"] = "nProton == 0 && nNeutron == 0 && (nPi0 + nPiPlus + nPiMinus) == 0";
    //cuts["ela"] = "nProton == 0 && nNeutron == 1 && (nPi0 + nPiPlus + nPiMinus) == 0";
    cuts["inel"] = "nProton == 0 && nNeutron >= 1 && (nPi0 + nPiPlus + nPiMinus) == 0";
    cuts["pprod"] = "nProton >=1 && (nPi0 + nPiPlus + nPiMinus) == 0";
